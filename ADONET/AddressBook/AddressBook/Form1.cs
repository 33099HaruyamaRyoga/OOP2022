...
namespace AddressBook {
    public partial class Form1 : Form {
        ...
        //BindingList<Addressbook> addressbooks = new BindingList<Addressbook>();
        ...
        private void Form1_Load(object sender, EventArgs e) {
            // TODO: このコード行はデータを 'infosys202210DataSet.AddressTable' テーブルに読み込みます。必要に応じて移動、または削除をしてください。
            //this.addressTableTableAdapter.Fill(this.infosys202210DataSet.AddressTable);
        ...
        private void btImageDeleate_Click(object sender, EventArgs e) {
            pbImage.Image = null;
        }
        ...
        private void btAdd_Click(object sender, EventArgs e) {
            ...
            //データベース更新
            this.addressTableTableAdapter.Update(this.infosys202210DataSet.AddressTable);
        }
        ...
        private void btNameSerch_Click(object sender, EventArgs e) {
            addressTableTableAdapter.FillByName(infosys202210DataSet.AddressTable, tbNameSerch.Text);
        }
